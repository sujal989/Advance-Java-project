...
<div class="header">
  ...
  <div class="row">
    <div class="col-2">
      <h1>NEW ARRIVALS</h1>
      <p>"Quality isn't just what we promise — what we deliver.<br>Because your trust deserves excellence."</p>
      <a href="product.jsp" class="btn">Shop Now</a>
    </div>
    <div class="col-2">
      <img src="images/still-life-spring-wardrobe-switch.jpg" alt="Spring Wardrobe">
    </div>
  </div>
</div>
...
<div class="categories">
  <div class="small-container">
    <div class="row">
      <div class="col-3"><img src="images/category-1.jpg" alt="Category 1"></div>
      <div class="col-3"><img src="images/category-2.jpg" alt="Category 2"></div>
      <div class="col-3"><img src="images/category-3.jpg" alt="Category 3"></div>
    </div>
  </div>
</div>
...
<div class="offer">
  <div class="small-container">
    <div class="row">
      <div class="col-2">
        <img src="images/exclusive.png" class="offer-img" alt="Exclusive Product">
      </div>
      <div class="col-2">
        <p>Exclusively Available on Elite Wear</p>
        <h1>PSD WATCH</h1>
        <small>This PSD Watch is a wonderful watch which is limited in our store right now!<br>
        This watch is limited for up to 10 Days Only!</small>
        <a href="product.jsp" class="btn">BUY NOW &#8594;</a>
      </div>
    </div>
  </div>
</div>
  ...
  <div class="small-container">
    <div class="row">
      <div class="col-3">
        ...
        <p>"Elite Wear blends comfort with class. I'm always impressed!"</p>
        <div class="rating">
          <i class="fa fa-star"></i><i class="fa fa-star"></i>
          <i class="fa fa-star"></i><i class="fa fa-star"></i>
          <i class="fa fa-star-o"></i>
        </div>
        <img src="images/test-1.jpg" alt="Testimonial 1">
        <h3>Pandit Narayan</h3>
      </div>
      <div class="col-3">
        <i class="fa fa-quote-left"></i>
        <p>"Love the fit and finish! Elite Wear always makes me stand out."</p>
        <div class="rating">
          <i class="fa fa-star"></i><i class="fa fa-star"></i>
          <i class="fa fa-star"></i><i class="fa fa-star"></i>
          <i class="fa fa-star-o"></i>
        </div>
        <img src="images/test-2.jpg" alt="Testimonial 2">
        <h3>The Lady</h3>
      </div>
      <div class="col-3">
        <i class="fa fa-quote-left"></i>
        <p>"Elite Wear nails it every time stylish, comfortable, and top quality. My go-to brand!"</p>
        <div class="rating">
          <i class="fa fa-star"></i><i class="fa fa-star"></i>
          <i class="fa fa-star"></i><i class="fa fa-star"></i>
          <i class="fa fa-star-o"></i>
        </div>
        <img src="images/test-3.png" alt="Testimonial 3">
        <h3>Ramri Manxey</h3>
      </div>
    </div>
  </div>
